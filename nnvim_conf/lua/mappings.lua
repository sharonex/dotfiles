...
vim.keymap.set("n", "<leader>sP", "<cmd> Telescope grep_string <CR>", {desc = "Find current word in files"})
...
vim.keymap.set("i", "<C-e>", "<ESC>A", {desc = "Insert at end of line"})
vim.keymap.set("i", "<C-f>", "<ESC>la", {desc = "Move right"})
vim.keymap.set("i", "<C-b>", "<ESC>hi", {desc = "Move left"})
vim.keymap.set("i", "<A-f>", "<ESC>lwi", {desc = "Move word right"})
vim.keymap.set("i", "<A-b>", "<ESC>bi", {desc = "Move word left"})
vim.keymap.set("i", "<C-d>", "<ESC>lxi", {desc = "Delete character"})
vim.keymap.set("i", "<A-d>", "<ESC>lcw", {desc = "Delete word right"})
vim.keymap.set("i", "<C-k>", "<ESC>Da", {desc = "Delete to end of line"})
vim.keymap.set("i", "<C-u>", "<ESC>ld^i", {desc = "Delete to beginning of line"})
...
vim.keymap.set("n", "dsf", "ds)db", {desc = "Delete surrounding function"})

vim.keymap.set("n", "J", "gJ", {desc = "Join lines without spaces"})
vim.keymap.set("n", "J", "gJ", {desc = "Join lines without spaces"})
...
-- Code actions
vim.keymap.set("n", "<leader>ca", "<cmd>CodeActionMenu<cr>", {desc = "Open code actions"})
vim.keymap.set("v", "<leader>ca", "<cmd>CodeActionMenu<cr>", {desc = "Open code actions"})
...
-- trouble
vim.keymap.set("n", "<leader>ll", "<cmd> lua vim.diagnostic.open_float({scope=\"line\"}) <cr>", { desc = "Show line diagnostics" })
vim.keymap.set("n", "<leader>lc", "<cmd> lua vim.diagnostic.open_float({scope=\"cursor\"}) <cr>", { desc = "Show line diagnostics" })
